window.onload=function(){
	...
	var yinyueku=[
      {name:'上下',src:'shang.mp3',singer:'EXID',duration:'3:10'},
      {name:'Over It',src:'Over It.mp3',singer:'Katharine McPhee',duration:'3:35'},
      {name:'倩女幽魂',src:'qnyh.mp3',singer:'张国荣',duration:'3:34'},
      {name:'i Do',src:'ywcbs.mp3',singer:'Felix Jaehn',duration:'3:02'}
  ]
...
var createList=function(){
     ...
     for(var i=0;i<yinyueku.length;i++){
        ...
        el+='<li mid="j0" class="'+ac+'"><strong class="music_name">'+yinyueku[i].name+'</strong><strong class="singer_name">'+yinyueku[i].singer+'</strong><strong class="play_time">'+yinyueku[i].duration+'</strong><div class="list_cp"><strong class="btn_like" title="喜欢" name="myfav_0038RM350w8m1V" mid="0038RM350w8m1V"><span>我喜欢</span></strong><strong class="btn_share" title="分享"><span>分享</span></strong><strong class="btn_fav" title="收藏到歌单"><span>收藏</span></strong><strong class="btn_del" title="从列表中删除"><span>删除</span></strong></div></li>';
    }
